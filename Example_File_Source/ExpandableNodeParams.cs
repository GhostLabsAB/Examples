...
namespace GhostNodes.SourceAssembly
{
    ...
    public class ExpandableNodeParams : NodeExpandableParametersBase<ExpandableNodeParams>
    {
        ...
        [DisplayName("FileNameWithoutExtension"), Description("Gets the name of the file without the extension part of the file."), Category("Expandable")]
        ...
        [DisplayName("CreationTime"), Description("Gets the creation time of the current file or directory."), Category("Expandable")]
        public DateTime CreationTime { get; set; }


        [DisplayName("CreationTimeUtc"), Description("Gets the creation time, in coordinated universal time (UTC), of the current file or directory."), Category("Expandable")]
        public DateTime CreationTimeUtc { get; set; }


        [DisplayName("LastWriteTime"), Description("Gets the time when the current file or directory was last written to."), Category("Expandable")]
        public DateTime LastWriteTime { get; set; }


        [DisplayName("LastWriteTimeUtc"), Description("Gets the time, in coordinated universal time (UTC), when the current file or directory was last written to."), Category("Expandable")]
